...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateExpenseStatus;

  private final SharedSQLiteStatement __preparedStmtOfUpdateExpenseDetails;
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteExpensesByStatus;
  ...
  public ExpenseDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpense = new EntityInsertionAdapter<Expense>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `expenses` (`id`,`date`,`amount`,`merchant`,`description`,`category`,`status`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfExpense = new EntityDeletionOrUpdateAdapter<Expense>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `expenses` SET `id` = ?,`date` = ?,`amount` = ?,`merchant` = ?,`description` = ?,`category` = ?,`status` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfUpdateExpenseStatus = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE expenses SET status = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateExpenseDetails = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE expenses SET description = ?, category = ?, status = ? WHERE id = ?";
        return _query;
      }
    };
    ...
    this.__preparedStmtOfDeleteExpensesByStatus = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM expenses WHERE status = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updateExpenseStatus(final long id, final String status,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateExpenseStatus.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfUpdateExpenseStatus.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object updateExpenseDetails(final long id, final String description, final String category,
      final String status, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateExpenseDetails.acquire();
        int _argIndex = 1;
        if (description == null) {
        ...
        try {
          ...
          __preparedStmtOfUpdateExpenseDetails.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object deleteExpensesByStatus(final String status,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteExpensesByStatus.acquire();
        int _argIndex = 1;
        _stmt.bindString(_argIndex, status);
        try {
          __db.beginTransaction();
          ...
          __preparedStmtOfDeleteExpensesByStatus.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<Expense> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Expense(_tmpId,_tmpDate,_tmpAmount,_tmpMerchant,_tmpDescription,_tmpCategory,_tmpStatus);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Expense call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpStatus;
            _tmpStatus = _cursor.getString(_cursorIndexOfStatus);
            _result = new Expense(_tmpId,_tmpDate,_tmpAmount,_tmpMerchant,_tmpDescription,_tmpCategory,_tmpStatus);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<Expense>> getExpensesByStatus(final String status) {
    final String _sql = "SELECT * FROM expenses WHERE status = ? ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Flow<List<Expense>> getPendingExpenses() {
    final String _sql = "SELECT * FROM expenses WHERE status = 'pending' ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"expenses"}, new Callable<List<Expense>>() {
      @Override
      @NonNull
  ...
  @Override
  public Flow<List<Expense>> getCompleteExpenses() {
    final String _sql = "SELECT * FROM expenses WHERE status = 'complete' ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"expenses"}, new Callable<List<Expense>>() {
      @Override
      @NonNull
  ...
  @Override
  public Flow<List<Expense>> getExpensesByMerchant(final String merchant) {
    final String _sql = "SELECT * FROM expenses WHERE merchant LIKE '%' || ? || '%' ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Flow<List<Expense>> getExpensesByMonth(final String monthYear) {
    final String _sql = "\n"
  ...
  @Override
  public Flow<List<Expense>> searchExpenses(final String query) {
    final String _sql = "\n"
            + "        SELECT * FROM expenses \n"
  ...
  @Override
  public Object getTotalAmountByStatus(final String status,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE status = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, status);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getTotalAmountByCategory(final String category,
      final Continuation<? super Double> $completion) {
  ...
  @Override
  public Object getExpenseCountByStatus(final String status,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM expenses WHERE status = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, status);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  public Object getAllCategories(final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT DISTINCT category FROM expenses WHERE category IS NOT NULL AND category != '' ORDER BY category";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getAllMerchants(final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT DISTINCT merchant FROM expenses ORDER BY merchant";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<String>>() {
      @Override
  ...
  @Override
  public Flow<List<Expense>> getRecentExpenses(final long daysAgo) {
    final String _sql = "SELECT * FROM expenses WHERE date >= ? ORDER BY date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, daysAgo);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"expenses"}, new Callable<List<Expense>>() {
      @Override
      @NonNull
      public List<Expense> call() throws Exception {
